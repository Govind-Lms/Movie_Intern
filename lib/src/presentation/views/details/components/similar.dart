...
import 'package:movie_intern/src/core/state_management/cubit/movies/similar_movie/similar_movie_cubit.dart';
          ...
          builder: (context, state) {
            if (state is SimilarIsLoading) {
              ...
              return  ListView.builder(
                  ...
                  itemCount: state.movieModel.movies.length,
                  itemBuilder: (BuildContext context, int index) {
                    final movies = state.movieModel.movies;
                    return InkWell(
                      onTap: (){
